...
public class AndroidPushBatchUniMsg {
	public static void main(String[] args)
		...
		String apiKey = "iOmM8Ew2QBRpcbhm3h26mXH5";
		String secretKey = "8qq1ys4glxLOf02NN7qZ6qKsGFgthWuX";
		PushKeyPair pair = new PushKeyPair(apiKey, secretKey);
		String warningMsg = "你当前所处的位置安全系数较低，请注意周边环境！";
		...
		try {
			...
			notification.put("title", "系统预警");
			if(isChecked()) {
				notification.put("description", warningMsg);
				...
				String[] channelIds = {"4306744217829536351"};
