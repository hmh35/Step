...
public class BaiduPush {
    ...
    public static void pushActivity(Activities activities, List<User> monitoredList) throws PushClientException, PushServerException {
        ...
        try {
            ...
            notification.put("title", activities.getCreateName()+"创建活动");
...
/*            notification.put("notification_builder_id", 0);
            ...
            jsonCustormCont.put("Activities_No",activities.getActNo());
            jsonCustormCont.put("Creator_Name",activities.getCreateName());
...
/*        String apiKey = "uVmeh9fQ67cXM1NK57D4iIs0SKFvByFy";
        ...
        try {
            ...
            notification.put("description","姓名:"+user.getRealName()+"在经纬度"+position.getAddrLat()+","+position.getAddrLong()+"向你紧急求救，点击获取他的位置");
/*            notification.put("notification_builder_id", 0);
            notification.put("notification_basic_style", 4);
            notification.put("open_type", 3);*/
            //notification.put("url", "http://push.baidu.com");
            JSONObject jsonCustormCont = new JSONObject();
            jsonCustormCont.put("push_Type", "sos"); //自定义内容，key-value
            jsonCustormCont.put("SOS_Id",user.getUserId());
            jsonCustormCont.put("Address_Lat",position.getAddrLat());
            jsonCustormCont.put("Address_Long",position.getAddrLong());
            notification.put("custom_content",jsonCustormCont);
            List<String> channelIdList = new ArrayList<>();
    ...
    * 推送位置分享通知
    * */
    public static void pushShareInfo(User user,Timestamp start,Timestamp stop, List<User> monitorList) throws PushServerException, PushClientException {
/*        String apiKey = "uVmeh9fQ67cXM1NK57D4iIs0SKFvByFy";
        String secretKey = "LLdHZ29iKsp6cGUeWW6ErrBHDZYkYzS3";*/
        String apiKey = "1GjoGSwWKFGsEAm49FkYVx1Z7RBExKtE";
        String secretKey = "Zma1du6crQuetN8zBYL8rX9DTBjfRdrG";
        ...
        try {
            ...
            //创建Android通知
            JSONObject notification = new JSONObject();
            notification.put("title", user.getRealName()+"发起位置分享");
            notification.put("description","赶快点击获取他的分享信息吧");
/*            notification.put("notification_builder_id", 0);
            notification.put("notification_basic_style", 4);
            notification.put("open_type", 3);*/
            //notification.put("url", "http://push.baidu.com");
            JSONObject jsonCustormCont = new JSONObject();
            jsonCustormCont.put("push_Type", "location"); //自定义内容，key-value
            jsonCustormCont.put("ShareUser_Id",user.getUserId());
            jsonCustormCont.put("ShareUser_Name",user.getRealName());
            jsonCustormCont.put("Share_timeStart",start);
            jsonCustormCont.put("Share_timeStop",stop);
            notification.put("custom_content",jsonCustormCont);
            List<String> channelIdList = new ArrayList<>();
            for (int i = 0; i < monitorList.size(); i++) {
                if (monitorList.get(i).getChannelId() == null || monitorList.get(i).getChannelId().toString().equals("")) {
